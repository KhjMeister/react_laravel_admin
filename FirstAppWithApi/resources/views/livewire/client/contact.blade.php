    ...
    <section>
        <div class="contacts-detail">
            <div class="item-contacts">
                ...
                <select wire:model="search" style="width:180px;background-color:#f7f7f7;font-size:15px;"
                    class="dropdown-content link-mouse-hover">
                    ...
                    <div style="{{ $this->addModal }}" class="modal">
                        <div class="modal-content">
                            ...
                            <form wire:submit.prevent="storeContact" class="form-group">
                                <div>
                                    ...
                                    <input wire:model.debounce.1000ms="username"
                                        class="@error('username') is-invalid @enderror" type="text"
                                ...
                                <div>
                                    ...
                                    <input wire:model.debounce.1000ms="phone"
                                ...
                                <div class="dropdown">
                                    ...
                                    <select wire:model="ca_id" id="categoryFormDropdown"
                                        class="@error('ca_id') is-invalid @enderror dropdown-content ">
                                        @if (!$this->categories == null)
                                ...
                                <div>
                                    ...
                                    <input wire:model.debounce.1000ms="semat"
                                        class="@error('semat') is-invalid @enderror" type="text"
                                        placeholder="سمت را مشخص نمایید">
                                    @error('semat')
                                        <span class="invalid-feedback">{{ $message }}</span>
                                    @enderror
                                </div>
                     ...
                     <div style="{{ $this->delModal }}" class="close-modal">
                        <div class="close-modal-content">
                            <span wire:click="$emit('closeDeleteModal')" class="closecreate close">&times;</span>
                            <div  class="form-group">
                                <div>
                                    <label for="fullname">حذف مخاطب {{ $this->username }}</label>
                                   
                                </div>
                                <button wire:click="deleteContact()"  class="close-btn-form">
                                    حذف مخاطب
                                </button>
                ...
                <div class="item-detail">
                    ...
                    <div style="{{$this->editModal}}" class="modal">
                        <div class="modal-content">
                            <span class="closecreate close" wire:click="$emit('closeEditeModal')">&times;</span>
            ...
            <table class="tablecontacts">
                ...
                @foreach ($contacts as $contact)
                    <tr>
                        ...
                        <td>
                            <svg wire:click="editeContact({{ $contact->id }})"
                                class="myBtnEditeContact link-mouse-hover" width="18" height="18" viewBox="0 0 18 18"
                        ...
                        <td>
                            <svg wire:click.prevent="modalDeleteContact({{ $contact->id }})" class="link-mouse-hover" width="24"
                                ...
                                <path
                                    ...
                                    fill="#F51100" />
                                <path
                                    d="M9.95457 16.5C10.6324 16.5 11.1818 15.9963 11.1818 15.375V10.875C11.1818 10.2537 10.6324 9.75 9.95457 9.75C9.27677 9.75 8.72729 10.2537 8.72729 10.875V15.375C8.72729 15.9963 9.27677 16.5 9.95457 16.5Z"
                                    fill="#F51100" />
                                <path
                                    d="M14.0454 16.5C14.7232 16.5 15.2727 15.9963 15.2727 15.375V10.875C15.2727 10.2537 14.7232 9.75 14.0454 9.75C13.3676 9.75 12.8182 10.2537 12.8182 10.875V15.375C12.8182 15.9963 13.3676 16.5 14.0454 16.5Z"
                                    fill="#F51100" />
                            </svg>
