         ...
         <div wire:ignore.self class="modal fade" id="startnewVoice" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <div class="requests">
                        ...
                        <div class="content">
                            <form class="form text-center" dir="rtl">
                                ...
                                <button wire:click.prevent="storeContact()" data-dismiss="modal" class="btn btn-vip text-white my-2">اضافه کردن مخاطب</button>
                            </form>
                        </div>
                    </div>
                </div>
