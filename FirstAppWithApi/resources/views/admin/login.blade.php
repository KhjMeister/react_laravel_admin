...
@push('styles')
    <link rel="stylesheet" href="{{ asset('admin/frest/vendor/libs/formvalidation/dist/css/formValidation.min.css') }}">
    <link rel="stylesheet" href="{{ asset('admin/frest/vendor/css/pages/page-auth.css') }}">
@endpush

@push('scripts')
    <script src="{{ asset('admin/frest/vendor/js/helpers.js') }}"></script>
    <script src="{{ asset('admin/frest/js/config.js') }}"></script>

    <script src="{{ asset('admin/frest/vendor/libs/formvalidation/dist/js/FormValidation.min.js') }}"></script>
    <script src="{{ asset('admin/frest/vendor/libs/formvalidation/dist/js/plugins/Bootstrap5.min.js') }}"></script>
    <script src="{{ asset('admin/frest/vendor/libs/formvalidation/dist/js/plugins/AutoFocus.min.js') }}"></script>

    <script src="{{ asset('admin/frest/js/main.js') }}"></script>
    <script src="{{ asset('admin/frest/js/pages-auth.js') }}"></script>
@endpush
        ...
        <div class="authentication-inner py-4">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p class="mb-4">لطفا وارد حساب خود شده </p>
