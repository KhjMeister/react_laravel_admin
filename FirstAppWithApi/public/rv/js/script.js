...
//-- switch dark theme
    ...
    // تغییر عرض sidebar به هنگام کلیک بر روی آیتم های tab
    document.getElementsByClassName('testW')[0].onclick = function(){
         var item = document.getElementById('sidebar')
        item.style.minWidth='1030px';
    }

    document.getElementsByClassName('notificationsW')[0].onclick = function(){
        var item = document.getElementById('sidebar')
        item.style.minWidth='370px';
    }
    document.getElementsByClassName('discussionsW')[0].onclick = function(){
        var item = document.getElementById('sidebar')
        item.style.minWidth='370px';
    }
    document.getElementsByClassName('membersW')[0].onclick = function(){
        var item = document.getElementById('sidebar')
        item.style.minWidth='370px';
    }
    document.getElementsByClassName('settingsW')[0].onclick = function(){
        var item = document.getElementById('sidebar')
        item.style.minWidth='370px';
    }
